  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6 xl:grid-cols-3">
        {/* Activity Feed */}
        <Card className="rounded-2xl border border-slate-100 dark:border-border bg-white dark:bg-card shadow-soft xl:col-span-2">
        ...
        <div className="space-y-4">
          ...
          <Card className="rounded-2xl border border-slate-100 dark:border-border bg-slate-50 dark:bg-[#0e1420] shadow-none">
            ...
            <div>
              ...
              <div className="grid gap-4 lg:grid-cols-3">
                {gatedModules.map((mod) => (
                  <Card
                    key={mod.id}
                    className="rounded-2xl border border-dashed border-slate-100 dark:border-border bg-slate-50 dark:bg-card shadow-none"
                  >
                    <CardHeader>
