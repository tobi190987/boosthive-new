      ...
      <Card className="rounded-[2rem] border border-slate-100 dark:border-[#252d3a] bg-white dark:bg-[#151c28] shadow-soft">
        <CardContent className="flex flex-col items-center gap-5 px-6 py-12 text-center">
          ...
          <div className="space-y-2">
            <h2 className="text-xl font-semibold text-slate-950 dark:text-slate-50">Ad Generator ist noch gesperrt</h2>
            <p className="max-w-2xl text-sm leading-7 text-slate-600 dark:text-slate-300">
              Dieses Modul ist fuer deinen Workspace noch nicht gebucht. Buche es in der Abrechnung, um KI-generierte Anzeigentexte zu erstellen.
            </p>
          </div>
          {isAdmin ? (
